  ...
  private createFromForm(): IDependencia {
    return {
      ...
      fechaModificacion: this.editForm.get(['fechaModificacion'])!.value
        ...
        : undefined,
      nombreContactoComercial: this.editForm.get(['nombreContactoComercial'])!.value,
      cargoContactoComercial: this.editForm.get(['cargoContactoComercial'])!.value,
      telefonoPrincipalContactoComercial: this.editForm.get(['telefonoPrincipalContactoComercial'])!.value,
      telefonoSecundarioContactoComercial: this.editForm.get(['telefonoSecundarioContactoComercial'])!.value,
      emailContactoComercial: this.editForm.get(['emailContactoComercial'])!.value,
      nombreContactoTecnico: this.editForm.get(['nombreContactoTecnico'])!.value,
      cargoContactoTecnico: this.editForm.get(['cargoContactoTecnico'])!.value,
      telefonoPrincipalContactoTecnico: this.editForm.get(['telefonoPrincipalContactoTecnico'])!.value,
      telefonoSecundarioContactoTecnico: this.editForm.get(['telefonoSecundarioContactoTecnico'])!.value,
      emailContactoTecnico: this.editForm.get(['emailContactoTecnico'])!.value,
