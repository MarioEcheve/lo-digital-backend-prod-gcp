...
export class FolioUpdateComponent implements OnInit {
  ...
  editForm = this.fb.group({
    ...
    fechaFirma: [],
    fechaLectura: [],
    asunto: [null, [Validators.maxLength(350)]],
    anotacion: [null, [Validators.maxLength(12000000)]],
    pdfFirmado: [],
  ...
  updateForm(folio: IFolio): void {
    this.editForm.patchValue({
      ...
      poseeArchivos: folio.poseeArchivos,
  ...
  private createFromForm(): IFolio {
    return {
      ...
      poseeArchivos: this.editForm.get(['poseeArchivos'])!.value,
